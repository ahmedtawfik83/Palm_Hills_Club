...
// import 'package:palm_hills_club/widgets/ConfirmResetWidget.dart';
...
//                   signUp(showResult, changeDisplay, setError, _backToSignIn),
...
Future<void> _configureAmplify() async {
  // AmplifyDataStore _dataStorePlugin =
...
class MyApp extends StatefulWidget {
  final AuthService authServ = Get.put(AuthService());
  final Function backToSignIn;

  MyApp({Key key, this.backToSignIn}) : super(key: key);
