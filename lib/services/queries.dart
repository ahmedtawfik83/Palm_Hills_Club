...
//       '''mutation MyMutation(\$username: AWSPhone!, \$userType: Int!) {
//           createUser(input: {club_id: \$club_id,username: \$username, userType: \$userType}) {
//             id
//             username
//             userType
//           }
...
//       '''mutation MyMutation(\$id: ID!, \$username: String!, \$email: String, \$createdAt: AWSDateTime, \$isVerified: Boolean) {
//           createUser(input: {id: \$id, username: \$username, email: \$email, createdAt: \$createdAt, isVerified: \$isVerified}) {
//             username
//             id
//           }
//         }
